...
[Releases page](https://github.com/eknowles/gedcom/releases). This will not
...
[gedcomq](https://godoc.org/github.com/eknowles/gedcom/gedcomq)** lets you
...
| [![GoDoc](https://godoc.org/github.com/eknowles/gedcom/q?status.svg)](https://godoc.org/github.com/eknowles/gedcom/q) <br/> `gedcom/q` | Package q is the gedcomq parser and engine. |
| [![GoDoc](https://godoc.org/github.com/eknowles/gedcom/gedcomq?status.svg)](https://godoc.org/github.com/eknowles/gedcom/gedcomq) <br/> `gedcom/gedcomq` | Gedcomq is a command line tool and query language for GEDCOM files heavily inspired by [jq](https://stedolan.github.io/jq/), in name and syntax. |
| [![GoDoc](https://godoc.org/github.com/eknowles/gedcom/html?status.svg)](https://godoc.org/github.com/eknowles/gedcom/html) <br/> `gedcom/html` | Package html is shared HTML rendering components that are shared by the other packages. |
| [![GoDoc](https://godoc.org/github.com/eknowles/gedcom/util?status.svg)](https://godoc.org/github.com/eknowles/gedcom/util) <br/> `gedcom/util` | Package util contains shared functions used by several packages. |
