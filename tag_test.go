...
var tagTests = map[string]struct {
	...
	"LABL":  {y, y, n, &gedcom.TagLabel, "Label"},
...
func TestTags(t *testing.T) {
	...
	t.Run("Sorting", func(t *testing.T) {
		...
		assert.Equal(t, []gedcom.Tag{
			...
			gedcom.TagAlias,
			gedcom.TagAncestors,
			gedcom.TagAncestorsInterest,
			gedcom.TagAncestralFileNumber,
			gedcom.TagAssociates,
			gedcom.TagAuthor,
			gedcom.TagBinaryObject,
			gedcom.TagCallNumber,
			gedcom.TagCaste,
			gedcom.TagCause,
			gedcom.TagChange,
			gedcom.TagCharacterSet,
			gedcom.TagChild,
			gedcom.TagChildrenCount,
			gedcom.TagCity,
			gedcom.TagConcatenation,
			gedcom.TagContinued,
			gedcom.TagCopyright,
			gedcom.TagCorporate,
			gedcom.TagCountry,
			gedcom.TagData,
			gedcom.TagDate,
			gedcom.TagDescendants,
			gedcom.TagDescendantsInterest,
			gedcom.TagDestination,
			gedcom.TagEducation,
			gedcom.TagEmail,
			gedcom.TagFact,
			gedcom.TagFamily,
			gedcom.TagFamilyChild,
			gedcom.TagFamilyFile,
			gedcom.TagFamilySpouse,
			gedcom.TagFax,
			gedcom.TagFile,
			gedcom.TagFormat,
			gedcom.TagGedcomInformation,
			gedcom.TagGivenName,
			gedcom.TagHeader,
			gedcom.TagHusband,
			gedcom.TagIdentityNumber,
			gedcom.TagIndividual,
			gedcom.TagLabel,
			gedcom.TagLanguage,
			gedcom.TagLatitude,
			gedcom.TagLegatee,
			gedcom.TagLongitude,
			gedcom.TagMap,
			gedcom.TagMarriageCount,
			gedcom.TagMedia,
			gedcom.TagNamePrefix,
			gedcom.TagNameSuffix,
			gedcom.TagNationality,
			gedcom.TagNickname,
			gedcom.TagNote,
			gedcom.TagObject,
			gedcom.TagOccupation,
			gedcom.TagOrdinance,
			gedcom.TagPage,
			gedcom.TagPedigree,
			gedcom.TagPhone,
			gedcom.TagPhonetic,
			gedcom.TagPhysicalDescription,
			gedcom.TagPlace,
			gedcom.TagPostalCode,
			gedcom.TagProperty,
			gedcom.TagPublication,
			gedcom.TagQualityOfData,
			gedcom.TagRecordFileNumber,
			gedcom.TagRecordIDNumber,
			gedcom.TagReference,
			gedcom.TagRelationship,
			gedcom.TagReligion,
			gedcom.TagRepository,
			gedcom.TagRestriction,
			gedcom.TagRole,
			gedcom.TagRomanized,
			gedcom.TagSex,
			gedcom.TagSocialSecurityNumber,
			gedcom.TagSource,
			gedcom.TagState,
			gedcom.TagStatus,
			gedcom.TagSubmission,
			gedcom.TagSubmitter,
			gedcom.TagSurname,
			gedcom.TagSurnamePrefix,
			gedcom.TagTemple,
			gedcom.TagText,
			gedcom.TagTime,
			gedcom.TagTitle,
			...
			gedcom.TagAdoption,
			gedcom.TagAdultChristening,
			gedcom.TagAnnulment,
			gedcom.TagBaptism,
			gedcom.TagBarMitzvah,
			gedcom.TagBasMitzvah,
			gedcom.TagBlessing,
			gedcom.TagCensus,
			gedcom.TagChristening,
			gedcom.TagConfirmation,
			gedcom.TagCremation,
			gedcom.TagDivorce,
			gedcom.TagDivorceFiled,
			gedcom.TagEmigration,
			gedcom.TagEndowment,
			gedcom.TagEngagement,
			gedcom.TagEvent,
			gedcom.TagFirstCommunion,
			gedcom.TagGraduation,
			gedcom.TagImmigration,
			gedcom.TagLDSBaptism,
			gedcom.TagLDSConfirmation,
			gedcom.TagMarriage,
			gedcom.TagMarriageBann,
			gedcom.TagMarriageContract,
			gedcom.TagMarriageLicence,
			gedcom.TagMarriageSettlement,
			gedcom.TagNaturalization,
			gedcom.TagOrdination,
			gedcom.TagProbate,
			gedcom.TagResidence,
			gedcom.TagRetirement,
			gedcom.TagSealingChild,
			gedcom.TagSealingSpouse,
			gedcom.TagWill,
			...
			gedcom.UnofficialTagLongitudeDegress,
